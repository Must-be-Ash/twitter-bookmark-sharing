  ...
  return (
    <div className="relative min-h-screen bg-white flex flex-col justify-between">
      <div className="absolute inset-0 opacity-15 z-0 flex justify-between items-center">
        ...
        >
          <path
            d="M0 20 Q 10 30, 20 20 T 40 20 T 60 20 T 80 20 T 100 20"
            stroke="#d3d3d3"
            strokeWidth="1"
            fill="none"
          />
          <path
            d="M0 50 Q 10 60, 20 50 T 40 50 T 60 50 T 80 50 T 100 50"
            stroke="#d3d3d3"
            strokeWidth="1"
            fill="none"
          />
          <path
            d="M0 80 Q 10 90, 20 80 T 40 80 T 60 80 T 80 80 T 100 80"
            stroke="#d3d3d3"
            strokeWidth="1"
            fill="none"
          />
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 z-10">
        ...
        <p className="text-gray-600 text-center mb-14 max-w-md">
          Share your Twitter bookmarks as a weekly newsletter. Think Pinterest,
          but for tweets.
        </p>
        <button
        ...
        >
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M23 3a10.9 10.9 0 01-3.14 1.53A4.48 4.48 0 0017 3a4.48 4.48 0 00-4.52 4.48 5.06 5.06 0 00.11 1.02A12.94 12.94 0 013 4s-4 9 5 13a13.38 13.38 0 01-7 2c9 5.8 20 0 20-11.5a4.48 4.48 0 00-.08-.83A8.1 8.1 0 0023 3z"
            />
          </svg>
          Log in with Twitter
        </button>
      ...
      <footer className="text-center py-4 z-10">
        <p className="text-gray-600">
          ...
          <Link href="https://x.com/Must_be_Ash">
            <div className="text-blue-500">@must_be_ash</div>
          </Link>
        </p>
      </footer>

      {isPulsing && (
        <div className="fixed inset-0 bg-blue-500 animate-pulse-expand z-50"></div>
      )}
