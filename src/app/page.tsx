  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-between">
      <main className="flex-grow flex flex-col items-center justify-center p-4">
        ...
        <button className="flex items-center px-6 py-2 bg-blue-500 text-white font-bold rounded transition-all duration-300 focus:outline-none focus:ring focus:ring-blue-300 glow-button">
