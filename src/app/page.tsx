...
export default function LandingPage() {
  ...
  const handleTwitterLogin = () => {
    window.location.href = 'https://twitter-bookmark-sharing.vercel.app/api/auth/signin';
  };

  return (
    <div className="min-h-screen bg-white flex flex-col justify-between relative">
      <div className="absolute inset-0 opacity-10 z-0">
        <img src="/bookmark.png" alt="Bookmark" className="w-1/2 h-1/2 absolute top-10 left-10" />
        <img src="/email.png" alt="Email" className="w-1/2 h-1/2 absolute bottom-10 right-10" />
      </div>
      <main className="flex-grow flex flex-col items-center justify-center p-4 z-10">
        ...
        <button 
          ...
          className="flex items-center px-6 py-2 bg-blue-500 text-white font-bold rounded transition-all duration-300 focus:outline-none focus:ring focus:ring-blue-300 glow-button">
